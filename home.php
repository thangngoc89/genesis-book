 ...
 *
 */
function be_article_post_class( $classes ) {
...
add_filter( 'post_class', 'be_article_post_class' );
 ...
 *
 */
function be_article_image() {
	echo wpautop( '<a href="' . get_permalink() . '">' . genesis_get_image( array( 'size' => 'medium' ) ). '</a>' );
}
add_action( 'genesis_entry_content', 'be_article_image' );
